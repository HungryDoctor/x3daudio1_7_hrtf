...
public:
	...
	virtual void get_direction_data(angle_t elevation, angle_t azimuth, distance_t distance, DirectionData & ref_data) const = 0;
	...
	virtual void sample_direction(angle_t elevation, angle_t azimuth, distance_t distance, uint32_t sample, float & value, float & delay) const = 0;
	...
	virtual uint32_t get_respoone_length() const = 0;
